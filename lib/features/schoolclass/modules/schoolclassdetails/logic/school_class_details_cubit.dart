...
abstract class SchoolClassDetailsCubit<T extends SchoolClassDTO>
    extends Cubit<SchoolClassDetailsState<T>> {
  final _repository = locator<SchoolClassRepo>();

  SchoolClassDetailsCubit()
    : super(SchoolClassDetailsState.initial());

  bool get isLoading =>
      state._status == _SchoolClassDetailsStatus.loading;
...
class CreateSchoolClassCubit
    extends SchoolClassDetailsCubit<CreateSchoolClassDto> {
...
class UpdateSchoolClassCubit
    extends SchoolClassDetailsCubit<UpdateSchoolClassDto> {
